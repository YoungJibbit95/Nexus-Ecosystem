...
export const wikiEntriesPrimary: WikiEntry[] = [
  ...
  {
    id: 'main-devtools-feature-flag-control',
    ...
    tags: ['devtools', 'feature-flags', 'control', 'rollout', 'audit'],
    sources: [
      'Nexus Main/src/app/controlFeatureFlags.ts',
      'Nexus Main/src/views/devtools/FeatureFlagControlPanel.tsx',
  ...
  },
  {
    ...
    category: 'view',
    summary:
      'DevTools kombiniert Visual Builder, FS-like Editor, UI Calculator, Release Health und Feature Flag Drafts fuer schnelle Frontend- und RC-Arbeit.',
    guide: [
    ...
    points: [
      ...
      'Feature Flags liefert lokale Control-Drafts mit Layout Guard, Rollout Plan und Audit Trail.',
      'Support Diagnostics exportiert redigierte Runtime- und RC-Signale ohne Secrets, Inhalte, Dateipfade oder LocalStorage-Werte.',
    ],
    commands: ['Copy CSS', 'Copy Tailwind', 'New html/css/js file', 'Copy release report', 'Export release JSON', 'Feature Flags -> Validate', 'Export support diagnostics'],
    tags: ['devtools', 'builder', 'calculator', 'css', 'release-health', 'feature-flags', 'diagnostics'],
    sources: ['Nexus Main/src/views/DevToolsView.tsx', 'Nexus Main/src/views/devtools/ReleaseHealthDashboard.tsx', 'Nexus Main/src/views/devtools/FeatureFlagControlPanel.tsx', 'Nexus Main/src/views/InfoView.tsx'],
  },
  {
