...
export const wikiEntriesSecondary: WikiEntry[] = [
  ...
  },
  {
    ...
    guide: [
      ...
      { title: '3. Runtime access list beachten', detail: 'Nur erlaubte Views werden in Navigation wirklich freigeschaltet.' },
    ],
    points: [
  ...
  },
  {
    ...
    category: 'workflow',
    summary:
      'Der cloud availability Tab in Control dient als Light Builder fuer feature and layout drafts und safe release handoff.',
    guide: [
      { title: '1. Runtime laden', detail: 'Aktuelle Runtime Daten einlesen.' },
      { title: '2. draft bearbeiten', detail: 'feature and layout drafts in draft anpassen und validieren.' },
      { title: '3. Promote', detail: 'Nach Checks auf release freigeben.' },
    ],
    points: [
      'Aenderungen folgen einem kontrollierten Freigabeprozess.',
      'layout profile Validation blockiert ungueltige Komponenten.',
      'release handoff ist ein expliziter Schritt.',
    ],
    commands: ['Public client checks'],
    tags: ['control', 'live-sync', 'release handoff'],
    sources: ['docs/USER_GUIDE.md', 'docs/DEVELOPER_GUIDE.md'],
  },
  {
    id: 'control-Account features-guide',
    title: 'Control: Account features Guide',
    app: 'control',
    category: 'workflow',
    summary:
      'Account features Tab verwaltet Tier-Views und User-Templates zur serverseitigen account feature access-Auswertung.',
    guide: [
    ...
    points: [
      'Website Login Flow muss mit API account feature access Entscheidungen harmonieren.',
      'Nur API ist autoritativ fuer Freigaben.',
      'UI-only Unlocks sind kein Sicherheitsmodell.',
    ],
    commands: ['Public client checks'],
    tags: ['Account features', 'tiers', 'account feature access', 'control'],
  ...
  },
  {
    ...
    points: [
      'Dashboard ist die operative Startansicht der Nexus Cloud.',
    ...
    sources: ['Private Nexus Cloud administration'],
  },
  {
    ...
    points: [
      'Manifest hilft bei Nachvollziehbarkeit zwischen release handoff und Build-Zustand.',
      'verify:ecosystem bleibt Pflicht vor release handoff.',
  ...
  },
  {
    ...
    guide: [
      { title: '1. Global Config laden', detail: 'Globale Access settings und Runtime Defaults im JSON Editor pruefen.' },
  ...
  {
    id: 'control-Access settings-guide',
    title: 'Control: Access settings Tab Guide',
    app: 'control',
    category: 'security',
    summary:
      'Access settings Tab ist die zentrale Pflegeflaeche fuer Security-Richtlinien und Owner-Restriktionen.',
    guide: [
      { title: '1. Access settings laden', detail: 'Aktuelle Security Access settings als Baseline einlesen.' },
    ...
    points: [
      'Access settings wirken direkt auf die Zugriffskontrolle im Betrieb.',
      'Unsichere Access settings koennen Baseline Enforcement triggern.',
      'Aenderungen immer mit Security Team abstimmen.',
    ],
    commands: ['Public client checks'],
    tags: ['Access settings', 'owner-only', 'security-baseline'],
    sources: ['Private Nexus Cloud administration'],
  },
  {
    id: 'control-Account devices-guide',
    title: 'Control: Account Account devices area Guide',
    app: 'control',
    category: 'security',
    summary:
      'Account Account devices area verwaltet die Admin-Device-access list inklusive Rollen, Freigabe und Sperrung.',
    guide: [
    ...
    commands: ['Public client checks'],
    tags: ['Account devices', 'access list', 'admin-security'],
    sources: ['Private Nexus Cloud administration'],
  },
  {
  ...
  },
  {
    ...
    points: [
      ...
      'API entscheidet final ueber account feature access.',
    ...
    tags: ['paywall', 'account feature access', 'view-guard', 'main-app'],
  ...
  },
  {
    ...
    points: [
      'Bottom-Nav und Sidebar respektieren dieselbe access list.',
    ...
    tags: ['mobile-paywall', 'view-guard', 'account feature access'],
  ...
  },
  {
    ...
    guide: [
      { title: '1. App Konfiguration trennen', detail: 'Entwicklungs-, draft- und Produktionswerte sauber voneinander isolieren.' },
  ...
  },
  {
    ...
    guide: [
      { title: '1. Device Hygiene', detail: 'Nur vertrauenswuerdige Account devices freigeben und regelmaessig bereinigen.' },
