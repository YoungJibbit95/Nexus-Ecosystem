...
export const englishEntryTranslations = {
  ...
  'release-gates': {
    ...
    points: [
      ...
      'The Release Ready Checklist is the operational starting point for RC approval.',
    ],
    commands: [
  ...
  'release-ready-checklist': {
    ...
    summary: 'The Release Ready Checklist is the central RC flow for local validation, installers, API data, visual evidence, public docs and security gates.',
    guide: g([
    ...
    points: [
      ...
      'API contract and attack tests are required for a public RC.',
      'Known issues are maintained next to the gates so accepted risks stay visible.',
      'Visual evidence is part of the RC definition, not only optional marketing material.',
    ],
    commands: [
      'npm run release:gate -- --fast',
      'npm run release:gate -- --with-api-contract',
  ...
  'release-known-issues': {
    title: 'Known Issues and RC Risks',
    summary: 'Known Issues documents hard blockers, accepted internal RC limitations and rules for open risks.',
    guide: g([
    ...
    points: [
      ...
      'A public release cannot keep hard known-issue blockers open.',
      'Secrets and private operational values are not documented in known issues.',
      'The document is intentionally short enough to be read before every RC.',
    ],
  ...
  'release-visual-evidence-guide': {
    ...
    points: [
      'Screenshots are release evidence and must be large enough to read.',
      'Videos are useful for Canvas move/zoom, drag/drop, mobile navigation and terminal/run loops.',
      'Evidence follows a fixed folder and filename structure.',
      'Every image is checked for private data and tokens before public upload.',
    ],
  ...
  'release-completion-plan': {
    title: 'Completion Plan and Release Roadmap',
    summary: 'The Completion Plan remains the large work list for UI, API, packaging, security and public docs until the Nexus v6 RC.',
    guide: g([
      ['1. Read status', 'Traffic lights, blockers, phases and the concrete next-work list show the real release state.'],
      ['2. Pick a work package', 'Prefer large steps: data hygiene, contract tests, view smokes, signing or UI shell extraction.'],
      ['3. Mark completion', 'After implementation, mark completed points in the plan and update the matching wiki/checklist links.'],
    ]),
    points: [
      'The plan does not replace an issue board, but it defines the current release path.',
      'Wiki, website and InfoView must stay synchronized after larger feature steps.',
      'Definition of done remains: builds, gates, secrets, smokes, signing and honest public docs.',
    ],
