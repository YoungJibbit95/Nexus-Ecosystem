        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              maxHeight: '80vh',
              overflowY: 'auto',
              background: theme.mode === 'dark' ? 'rgba(14,14,26,0.97)' : 'rgba(255,255,255,0.97)',
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 12 }}>
                ...
                >
                  {['Fira Code', 'JetBrains Mono', 'Source Code Pro', 'Monaco', 'Inter', 'system-ui'].map(font => (
              ...
              {[
                ...
                <div key={key} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: 12 }}>
                  ...
                  <input
                    ...
                    style={{ cursor: 'pointer', accentColor: theme.accent, width: 15, height: 15 }}
                  />
                </div>
              ))}
            </div>
