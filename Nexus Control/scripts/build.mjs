...
const runtimeConfig = {
  ...
  bootstrapPath: normalizePath(
    ...
    DEFAULT_RUNTIME_CONFIG.bootstrapPath,
  ),
  privateRepoHint: String(
    process.env.NEXUS_CONTROL_PRIVATE_REPO_HINT || "",
  ).trim(),
  forceApiUrl: parseBool(
    process.env.NEXUS_CONTROL_UI_FORCE_API_URL,
    DEFAULT_RUNTIME_CONFIG.forceApiUrl,
  ),
};
