...
import {
  ...
  MOBILE_SPOTLIGHT_POP_TRANSITION,
  ...
  const COMMANDS = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: Sparkles,
        action: () => t.preset("macOS Dark"),
      },
      {
        id: "preset-ocean",
        label: "Preset: Ocean Wave",
        icon: Sparkles,
        action: () => t.preset("Ocean Wave"),
      },
      {
        id: "preset-void",
        label: "Preset: Void",
        icon: Sparkles,
        action: () => t.preset("Void"),
      },
      {
        id: "settings",
        label: "Open Settings",
    ...
    [setView, setTerminalOpen, terminalOpen, t],
  );
            ...
            <motion.div
              ...
              transition={
                motionRuntime.reduced
                  ? { duration: 0.12 }
                  : (motionRuntime.spring ?? MOBILE_SPOTLIGHT_POP_TRANSITION)
              }
              style={{
                position: "fixed",
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: 11, opacity: 0.35, fontFamily: "monospace" }}
          >
            {timeStr}
          </span>
        </div>
      ...
      >
        ...
        <div
          style={{
            ...
            opacity: t.glow.gradientGlow
              ? expanded
                ? t.glow.intensity * 0.35
                : t.glow.intensity * 0.2
              : 0,
        ...
        >
          ...
          <AnimatePresence initial={false}>
            {expanded && (
              ...
              >
                  <span
                    style={{ fontSize: 10, fontWeight: 700, color: "#30D158" }}
                  >
                    {notes.length}
...
// ── Sub-components ────────────────────────────────────────────────
function LogoPill({ rgb, t, expanded, small, offset }: any) {
  const x = offset?.x ?? 0;
  const y = offset?.y ?? 0;
  return (
    <motion.div
            ...
            return (
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    selIdx === i ? `rgba(${iRgb},0.12)` : "transparent",
