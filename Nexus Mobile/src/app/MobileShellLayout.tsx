  ...
  return (
    <div
      ...
      style={{
        ...
        width: "var(--nx-mobile-vw, 100vw)",
        minWidth: "var(--nx-mobile-vw, 100vw)",
        maxWidth: "var(--nx-mobile-vw, 100vw)",
        height: "var(--nx-mobile-vh, 100dvh)",
        minHeight: "var(--nx-mobile-vh, 100dvh)",
        maxHeight: "var(--nx-mobile-vh, 100dvh)",
        overflow: "hidden",
        position: "relative",
