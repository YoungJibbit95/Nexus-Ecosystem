    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100%', overflow:'hidden' }}>
      ...
      <div style={{ flex:1, display:'flex', overflow:'hidden', minHeight:0 }}>
        {subTab === 'code' ? <>
          ...
          {/* Active file editor */}
          <div style={{ flex: mob.isMobile ? undefined : '0 0 45%', height: mob.isMobile ? '45%' : undefined, display:'flex', flexDirection:'column', overflow:'hidden', minHeight:0, borderRight:'1px solid rgba(255,255,255,0.07)' }}>
            {activeFile && <CodePane value={activeFile.content} onChange={v=>updateFile(activeFile.id,v)} lang={activeFile.type}/>}
          </div>

          {/* Preview + console */}
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minHeight: mob.isMobile ? '55%' : 0 }}>
