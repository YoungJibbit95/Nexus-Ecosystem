...
export function MobileSettingsShell({
  ...
  const exportTheme = () => {
    ...
    downloadJson("nexus-theme-v5.json", payload);
    setTransferFeedback({
      kind: "success",
  ...
  const exportSettings = () => {
    downloadJson("nexus-mobile-settings-v1.json", exportSettingsSnapshotFromTheme(t, "mobile"));
    setTransferFeedback({
      kind: "success",
      title: "Settings exportiert",
      details: [
        "Datei: nexus-mobile-settings-v1.json",
  ...
  const importSettings = (file: File) => {
    ...
    reader.onload = () => {
      ...
      const parsed = importSettingsSnapshotIntoTheme(t, data, "mobile");
      if ("errors" in parsed) {
        setTransferFeedback({
          kind: "error",
          title: "Settings Import fehlgeschlagen",
  ...
  const resetSettings = (scope: SettingsResetScope, label: string) => {
    resetThemeSettingsSection(t, scope, "mobile");
