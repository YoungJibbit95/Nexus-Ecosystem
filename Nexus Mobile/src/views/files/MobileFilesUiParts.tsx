...
import {
  MOBILE_FILE_WORKSPACE_COLORS,
  MOBILE_FILE_WORKSPACE_ICONS,
  TYPE_META,
  type FileItem,
  type ViewMode,
} from './mobileFilesTypes'
        ...
        <Glass glow style={{ width:420, maxWidth: mob.isMobile ? '92vw' : 420, padding:24 }}>
          ...
          <div style={{ marginBottom:14 }}>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:6 }}>
              {MOBILE_FILE_WORKSPACE_ICONS.map(i => (
          ...
          <div style={{ marginBottom:14 }}>
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:6 }}>
              {MOBILE_FILE_WORKSPACE_COLORS.map(c => (
      ...
      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:10 }}>
        ...
        <div style={{ display:'flex', gap:5, alignItems:'center' }}>
          ...
          <InteractiveIconButton
            motionId={`mobile-files-card-menu-${item.id}`}
    ...
    <Glass hover glow={active} style={{ padding:16, cursor:'pointer', border: active?`1.5px solid ${ws.color}`:'1px solid rgba(255,255,255,0.08)', position:'relative', overflow:'visible' }} onDoubleClick={onSelect}>
      ...
      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:12 }}>
        ...
        <div style={{ display:'flex', gap:4 }}>
          <InteractiveIconButton
            motionId={`mobile-workspace-edit-${ws.id}`}
          ...
          {ws.id !== 'default' && (
            <InteractiveIconButton
              motionId={`mobile-workspace-delete-${ws.id}`}
