...
export class MobileDashboardWidgetErrorBoundary extends React.Component<Props, State> {
  state: State = {
    hasError: false,
    message: null,
  };
  ...
  componentDidCatch(error: unknown) {
    console.error("[Mobile Dashboard] widget runtime render failed", {
  ...
  render() {
    ...
    return (
      ...
      >
        <div style={{ fontSize: 12, fontWeight: 800 }}>Widget Safe Mode aktiv</div>
