    ...
    return (
        <div className="nx-canvas-node"
            ...
            style={{
                ...
                animation: dragging || resizing || scalingNode ? undefined : 'nexus-scale-in 0.22s ease-out both',
                ...
                transform: isSelected
                    ...
                    : hovered
                        ...
                        : 'translateZ(0)',
                transition: dragging || resizing || scalingNode
                    ? 'none'
            ...
            <Glass
                type="panel"
                glow={isSelected}
                performanceProfile={resizing || scalingNode ? 'balanced' : 'auto'}
                className="h-full"
                style={{
                ...
                background: resizing || scalingNode
                    ? resizeSafeBackground
                    : isSticky
                        ? stickyBg
                        : `linear-gradient(180deg, rgba(${rgb},${t.mode === 'dark' ? '0.16' : '0.09'}) 0%, rgba(${rgb},0) 42%)`,
                backdropFilter: resizing || scalingNode ? 'none' : undefined,
                WebkitBackdropFilter: resizing || scalingNode ? 'none' : undefined,
                ...
                {(isSelected || hovered) && (
                    <div
                        ...
                        style={{
                            ...
                            width: 24, height: 24, cursor: 'nesw-resize',
                            display: 'flex', alignItems: 'flex-end', justifyContent: 'flex-start', padding: 6, opacity: 0.5,
                            zIndex: 50,
                        }}
                        title="Node + Inhalt zoomen"
                    >
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" style={{ pointerEvents: 'none' }}>
                            <path d="M1 1L1 9L9 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                )}
                </div>
